...
public class NaverLoginController {
  ...
  private String CLIENT_ID = "cCF5KU0iyUv7IaTz6V1M"; //애플리케이션 클라이언트 아이디값";
  private String CLI_SECRET = "Fipu6VM6BO"; //애플리케이션 클라이언트 시크릿값";
  ...
  public String testNaver(HttpSession session, Model model) throws UnsupportedEncodingException, UnknownHostException {
    ...
    String redirectURI = URLEncoder.encode("http://localhost:8081/naver/callback1", "UTF-8");
